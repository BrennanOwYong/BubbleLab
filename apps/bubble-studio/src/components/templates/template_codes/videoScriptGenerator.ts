...
\${video.transcript}
          ...
          <tr>
            <td style="padding: 25px 40px; background-color: #212529; text-align: center; border-top: 1px solid #495057;">
              <p style="margin: 0; color: #adb5bd; font-size: 12px;">Generated by Gluu Video Script Generator • <a href="#" style="color: #dee2e6; text-decoration: none;">Gluu</a></p>
            </td>
          </tr>
        </table>
      </td>
  ...
  private async sendScriptEmail(
    ...
    // and video insights. The 'from' parameter is automatically set to Gluu's

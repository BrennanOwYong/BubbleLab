...
EXAMPLE (Reddit Lead Generation — note the flow provisions its own spreadsheet, so setup steps never ask the user to create resources or copy IDs):

{
  "summary": "**Reddit Lead Generation Flow**\\n\\nAutomatically discovers potential leads from Reddit and saves them to a dedicated Google Sheet (created for you on first run) with AI-generated outreach messages.\\n\\n**Setup Before Testing:**\\n1. Connect your Google account on the Credentials page (used to create and update the leads spreadsheet)\\n\\n**To Test This Flow:**\\nProvide these inputs in the form:\\n- **spreadsheetName**: Name for your leads spreadsheet (defaults to \\"Reddit Leads\\" - the flow finds it by name or creates it on first run)\\n- **subreddit**: Enter subreddit name without r/ (e.g., \\"entrepreneur\\", \\"startups\\")\\n- **searchCriteria**: Describe your ideal lead (e.g., \\"people frustrated with current automation tools\\")\\n\\n**What Happens When You Run:**\\n1. Looks up a spreadsheet named \\"Reddit Leads\\" in your Google Drive and creates it (with header row) if it doesn't exist yet\\n2. Checks the spreadsheet for existing contacts to avoid duplicates\\n3. Scrapes 50 recent posts from your target subreddit\\n4. AI analyzes posts and identifies 10 new potential leads matching your criteria\\n5. Generates personalized, empathetic outreach messages for each lead\\n6. Adds new contacts to the spreadsheet with: Name, Post Link, Message, Date, and Status\\n\\n**Output You'll See:**\\n\`\`\`json\\n{\\n  \\"message\\": \\"Successfully added 10 new contacts to the spreadsheet.\\",\\n  \\"spreadsheetUrl\\": \\"https://docs.google.com/spreadsheets/d/...\\",\\n  \\"newContactsAdded\\": 10\\n}\\n\`\`\`\\n\\nOpen the spreadsheet link to see the new leads with ready-to-use outreach messages!",
  "inputsSchema": "{\\"type\\":\\"object\\",\\"properties\\":{\\"spreadsheetName\\":{\\"type\\":\\"string\\",\\"description\\":\\"Name of the leads spreadsheet. The flow finds it in your Google Drive by this name, or creates it on first run.\\",\\"default\\":\\"Reddit Leads\\"},\\"subreddit\\":{\\"type\\":\\"string\\",\\"description\\":\\"The subreddit to scrape for potential leads (e.g., \\\\\\"n8n\\\\\\", \\\\\\"entrepreneur\\\\\\")\\"},\\"searchCriteria\\":{\\"type\\":\\"string\\",\\"description\\":\\"Description of what type of users to identify (e.g., \\\\\\"expressing frustration with workflow automation tools\\\\\\")\\"}}},\\"required\\":[\\"subreddit\\",\\"searchCriteria\\"]}"
}

...
import { GITHUB_OPERATION_METADATA } from './github.metadata.js';
import { GITHUB_AUTH_METHODS } from './github.auth-methods.js';
...
> {
  ...
  static readonly operationMetadata = GITHUB_OPERATION_METADATA;
  // Doc-derived sign-in methods (IR-3/IR-4), see github.auth-methods.ts
  static readonly authMethods = GITHUB_AUTH_METHODS;
